...
namespace LMS_MVC.Controllers.Wzb
{
    public class ShiController : Controller
    {
        ...
        [Obsolete]
        public ShiController(IHostingEnvironment hostingEnvironment, IAlipayF2FService alipayF2FService)
        {
        ...
        private AlipayTradePrecreateContentBuilder BuildPrecreateContent(string orderName, string orderAmount, string outTradeNo)
        {
            ...
            //收款账号
            builder.seller_id = "2021000116693943";
            //订单编号
        ...
        public void LoopQuery(object o)
        {
            ...
            for (int i = 1; i <= count; i++)
            {
                ...
                {
                    DoSuccess_Process(queryResult);
                    return;
                }
            }
            DoFailed_Process(queryResult);
        }
